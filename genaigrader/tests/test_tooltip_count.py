...
class TooltipCountTest(TestCase):
    def setUp(self):
        ...
        Evaluation.objects.create(exam=exam, model=model, prompt="Test prompt 3", ev_date="2024-01-03 14:00:00", grade=7.5, time=11.5)
    ...
    def test_count_field_in_analysis_response(self):
        ...
        self.assertGreater(len(overall_model_averages), 0, "Should have at least one model average")
        ...
        self.assertEqual(test_model_data['count'], 3, "Count should be 3 for Test Model")
        ...
        self.assertGreater(len(test_course['model_averages']), 0, "Course should have model averages")
        ...
        self.assertIsNotNone(course_model_data, "Should find Test Model in course results")
        self.assertIn('count', course_model_data, "Count field should be present in course data")
        self.assertEqual(course_model_data['count'], 3, "Course count should be 3 for Test Model")